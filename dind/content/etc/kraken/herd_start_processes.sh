#!/bin/bash
mkdir -p /var/log/kraken/kraken-testfs /var/log/kraken/kraken-origin /var/log/kraken/kraken-tracker /var/log/kraken/kraken-build-index /var/log/kraken/kraken-proxy
